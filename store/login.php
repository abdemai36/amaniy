...
<body>
    ...
    <div class="h-screen w-screen flex">
        <div class="h-screen w-0 md:w-1/2 bg-cover" style="background-image: url('../images/Untitled-2.png');">
        </div>
        ...
        <div class="flex flex-col w-full md:w-1/2 md:mt-32">
           ...
           ?>
                ...
                <button type="submit" name="login-submit-store" class="bg-black text-white p-2 rounded-full"> تسجيل الدخول</button>
                <a href="create-store" class="text-yellow-400">ليس لديك حساب؟ </a>
            </form>
        </div>
    </div>

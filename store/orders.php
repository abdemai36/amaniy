                                ...
                                if($result)
                                {
                                    if(mysqli_num_rows($result)!=0)
                                    {
                                        while($row=mysqli_fetch_array($result))
                                        {
                                            ...
                                            for ($i=0; $i < $count; $i++) { 
                                                if($ID_owner_store[$i] == $id_owner_store){ ?>
                                                 <tr>
                                                    ...
                                                    <td class="border-b border-gray-200 bg-white text-center">
                                                        <form action="livre_store" method="POST">
                                                            <input type="hidden" name="id_order" value="<?php echo $row["ID_order"] ;?>">
                                                            <button name="livre" type="submit" class="detail bg-green-400 p-3 text-white rounded"> livré </button>
                                                        </form>
                                                    </td>
                                                    <td class=" border-b border-gray-200 bg-white text-center">
                                                    ...
                                                    <?php if(empty($row["code_livreur"])):?>
                                                        <td class=" border-b border-gray-200 bg-white text-center">
                                                            <a href="transferer?id=<?php echo $row["ID_order"];?>" class="transfir_code_livreur text-yellow-400 text-center flex justify-center items-center">
